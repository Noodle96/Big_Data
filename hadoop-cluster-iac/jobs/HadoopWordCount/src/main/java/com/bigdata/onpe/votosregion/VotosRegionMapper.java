...
public class VotosRegionMapper extends Mapper<LongWritable, Text, Text, IntWritable> {

    private final Text regionOrganizacion = new Text();
    ...
    protected void map(
        ...
        regionOrganizacion.set(region + "|" + organizacionPolitica);
        votos.set(votosValue);

        context.write(regionOrganizacion, votos);
    }
}