...
# ============================================================
# CONFIGURACIÓN GENERAL DEL LABORATORIO SPARK + EMR
# ============================================================

persistent_bucket_name: str = "bigdata-russell-academy"

emr_logs_uri: str = f"s3://{persistent_bucket_name}/logs/emr-spark/"
...
master_security_group = aws.ec2.SecurityGroup(
    resource_name="spark-emr-master-ssh-sg",
    description="Allow SSH access to Spark EMR primary node",
...
cluster = aws.emr.Cluster(
    resource_name="spark-emr-cluster",
...
pulumi.export(
    "taxi_s3_raw_path",
    f"s3://{persistent_bucket_name}/datasets/taxi/yellow/",
)

pulumi.export(
    "taxi_s3_curated_path",
    f"s3://{persistent_bucket_name}/datasets/taxi/yellow_curated/",
)
...
pulumi.export("hdfs_taxi_curated_path", "/datasets/taxi/yellow/curated")